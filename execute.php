...
switch($text){
    case "/start":
        sendMessage($chatId,"Benvenuto <b>$nome</b>! Come stai?",$tastierabenvenuto);
        break;
    case "ciao":
        sendMessage($chatId,"Ciao chi sei?",$tastierabenvenuto);
        break;
     case "$nome":
        sendMessage($chatId,"Lo sapevo <b>$nome</b>! Come stai?",$tastierabenvenuto);
        break;
    case "bene":
